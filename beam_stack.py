"""
# Random Pencil Beams of Light with a set of 3D coordinate objects
# QUASAR ED

Using a set of objects with given coordinates, the user can select or
randomise an arbitrary light beam which highlights all objects within
itself.

Can customise beam orientation (specify direction and 2 axis of rotation)
as well as angles of rotation. Can randomise light beam or center beam
around an object.
"""
...
def stack(halo_catalog, galaxy_lvm, qso_qvm, n, z, distance_modulus, beam_depth, beam_width, beam_length,
          gal_scatter, qso_scatter, dc, obs_gal_limit = 26.5, obs_qso_limit = 25.5, qso_select_limit = 22.41):
    """
